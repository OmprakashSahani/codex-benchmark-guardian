    ...
    steps:
      ...
      - name: Validate evidence and PR identity
        ...
        with:
          script: |
            ...
            const root = 'downloaded-evidence/benchmarks/';
      ...
      - name: Regenerate trusted handoff comment
        ...
        run: |
          ...
          .venv-publisher/bin/cbg handoff-pack --baseline downloaded-evidence/benchmarks/baseline.json --current downloaded-evidence/benchmarks/current.json --directions-config trusted-base/benchmarks/directions.json --threshold 25 --output-dir trusted-handoff
      - name: Publish trusted persistent comment
        ...
        with:
          script: |
            ...
            const provenance = JSON.parse(fs.readFileSync('downloaded-evidence/benchmarks/provenance.json', 'utf8'));
