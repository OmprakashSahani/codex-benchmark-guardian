...
export function PrReplay({ loading, status, onReplay }: PrReplayProps) {
  return <section className="replay-section" aria-labelledby="replay-title">
    <div className="replay-intro"><span className="eyebrow">Live verified replay</span><h2 id="replay-title">Try the regression-to-fix loop</h2><p>Replay the exact benchmark snapshots produced by PR #20. Each run sends the committed evidence through the current <code>/api/analyze</code> endpoint and is evaluated by the same Python engine used for uploads.</p><p>The protected GitHub Actions workflow generates <code>baseline.json</code>, <code>current.json</code>, and provenance data. Permanent PR #20 snapshots are committed under <code>examples/scenarios/pr-20/</code> so they remain available after workflow artifacts expire.</p><strong>Historical benchmark evidence · evaluated live</strong><a href={PR_20_URL} target="_blank" rel="noreferrer">View pull request <ExternalLink size={14} /></a></div>
